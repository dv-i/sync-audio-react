...
const incentives = [
	{
		name: "Instant Access",
		description:
			"Get access to your audio blazing fast as soon as you check out.",
		imageSrc:
	...
	},
	{
		...
		description:
			"Look how fast that cart is going. Pick the audio, the license and you're 99% done with everything",
		imageSrc:
					...
					<div className="grid grid-cols-1 items-center gap-x-16 gap-y-10 lg:grid-cols-2">
						<div>
							<h2 className="text-4xl font-bold tracking-tight text-gray-900">
								Unlock the Soundtrack to Your Creativity
							</h2>
							<p className="mt-4 text-gray-500">
								Discover endless possibilities with our premium
								audio licenses. Elevate your projects with ease,
								whether you're a creator, filmmaker, or business
								owner. Explore, license, and unlock the power of
								sound today.
							</p>
						</div>
...
function CategoryFilter(): JSX.Element {
	...
	const activeTempoFilter = filters
		.filter((_) => _.id === "Tempo")[0]
		.options.filter((_) => _.checked);

	const activeGenereFilter = filters
		.filter((_) => _.id === "Genere")[0]
		.options.filter((_) => _.checked);
